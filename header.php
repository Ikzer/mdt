...
<html lang="en">
  <head>
	<title>Mundo de Tinieblas</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  function init() {
    ...
    function nodeDoubleClick(e, obj) {
      ...
      if (clicked !== null) {
        ...
        var newemp = { key: nextkey, name: "(new person)", title: "", embraced: "", parent: thisemp.key };
      ...
      $(go.Node, "Auto",
        ...
        $(go.Panel, "Horizontal",
          ...
          $(go.Panel, "Table",
            ...
            $(go.TextBlock, "Embraced: ", textStyle(),
              { row: 2, column: 0 }),
            $(go.TextBlock, textStyle(),
              {
	...
	<nav class="navbar fixed-top navbar-toggleable-md navbar-inverse bg-inverse">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav">
				  <li class="nav-item nav-link active" href="#">Main <span class="sr-only">(current)</span></li>
				  <li class="nav-item nav-link" href="characterlog.php">Character Logs</li>
				  <li class="nav-item nav-link" href="#">DM Logs</li>
				  <li class="nav-item nav-link" href="#">Chronicles</li>
				 </ul>
			</div>	
			<div class="collapse navbar-collapse navbar-right" id="navbarNavDropdown">
				<ul class="navbar-nav">
				  <li class="nav-item nav-link" href="#">Stats</li>
				  <li class="nav-item nav-link" href="#">Help</li>
				  <li class="nav-item nav-link" href="#">Donate</li>
				  <li class="nav-item nav-link" href="#">FB</li>
				  <li class="nav-item nav-link" href="#">TW</li>
